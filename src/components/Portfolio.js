  ...
  return (
    ...
    <div className="portfolio">
        ...
        <div className="portfolio__container ">
            <div className="portfolio__img w3-animate-bottom w3-animate-zoom"  >
            ...
            <div className="portfolio__img w3-animate-bottom"><a href="https://html-form-flax.vercel.app/" target="_blank"><img loading="lazy"
